...
const getSpeakerBegin = () => ({ type: "GET_SPEAKER_BEGIN" })
...
export const getSpeaker = speakerId => dispatch => {
    dispatch(getSpeakerBegin())
    fetch(
        `https://r10app-95fea.firebaseio.com/speakers.json?orderBy=%22speaker_id%22&equalTo=%22${
            speakerId
        }%22`
    )
        .then(resp => resp.json())
